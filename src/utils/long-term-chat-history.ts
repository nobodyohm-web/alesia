...
import { getAlesiaDir } from './paths.js';
 ...
 * Stores messages in .alesia/messages/chat_history.json
 */
export class LongTermChatHistory {
  ...
  constructor(baseDir: string = process.cwd()) {
    this.filePath = join(baseDir, getAlesiaDir(), MESSAGES_DIR, MESSAGES_FILE);
  }
