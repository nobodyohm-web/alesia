...
const HEARTBEAT_MD_PATH = alesiaPath('HEARTBEAT.md');
const HEARTBEAT_JOB_NAME = 'Heartbeat';

export const HEARTBEAT_TOOL_DESCRIPTION = `
Manage your periodic heartbeat checklist (.alesia/HEARTBEAT.md).
...
export const heartbeatTool = new DynamicStructuredTool({
  name: 'heartbeat',
  description:
    'View or update the heartbeat checklist (.alesia/HEARTBEAT.md) that controls periodic monitoring.',
